...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //printedWork.applyStyles(PrintedWork.STYLE_BOLD | PrintedWork.STYLE_STRIKETHROUGH);
        printedWork.applyStyles(EnumSet.of(Style.BOLD, Style.STRIKETHROUGH, Style.BOLD));
    }
}
